...
sys.path.insert(0, './Yolov5_DeepSort/Yolov5_DeepSort_Pytorch/yolov5')
sys.path.insert(1, './Yolov5_DeepSort/Yolov5_DeepSort_Pytorch')
...
FILE = Path("./Yolov5_DeepSort/Yolov5_DeepSort_Pytorch/track.py").resolve() #__file__
...
def track(yolo_model='yolov5m.pt', deep_sort_model='osnet_ibn_x1_0_MSMT17', source='0', output='./Yolov5_DeepSort/Yolov5_DeepSort_Pytorch/inference/output', imgsz=[640], conf_thres=0.5,
            iou_thres=0.5, fourcc='mp4v', device='', show_vid=False, save_vid=False, save_txt=False, classes=0, agnostic_nms=False, augment=False,
            evaluate=False, config_deepsort='./Yolov5_DeepSort/Yolov5_DeepSort_Pytorch/deep_sort/configs/deep_sort.yaml', half=False, visualize=False, max_det=1000, dnn=False, project= ROOT / 'runs/track',
            name='exp', exist_ok=False, save_dir='./results'):

    opt = Arguments()
    opt.yolo_model = yolo_model
    opt.deep_sort_model = deep_sort_model
    opt.source = source
    opt.output = output
    opt.imgsz = imgsz
    ...
    opt.fourcc = fourcc
    opt.device = device
    opt.show_vid = show_vid
    opt.save_vid = save_vid
    opt.save_txt = save_txt
    opt.classes = classes
    opt.agnostic_nms = agnostic_nms
    opt.augment = augment
    opt.evaluate = evaluate
    opt.config_deepsort = config_deepsort
    opt.half = half
    opt.visualize = visualize
    opt.max_det = max_det
    opt.dnn = dnn
    opt.project = project
    opt.name = name
